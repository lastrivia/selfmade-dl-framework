...
friend Tensor sub_broadcast(const Tensor &a, const Tensor &b);
friend Tensor mul_broadcast(const Tensor &a, const Tensor &b);
friend Tensor div_broadcast(const Tensor &a, const Tensor &b);
